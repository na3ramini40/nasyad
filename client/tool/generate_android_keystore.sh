...
# Keep the .jks private; add it to GitHub Actions secrets (see docs/domain/release.md).
set -euo pipefail
...
echo "  - Release APKs: GitHub Actions secrets (maintainer) — docs/domain/release.md"
...
echo "  2. Add GitHub secrets (see docs/domain/release.md)."
