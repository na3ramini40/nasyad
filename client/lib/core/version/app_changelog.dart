  ...
  static const List<ChangelogEntry> entries = [
    ChangelogEntry(
      ...
      en: [
        ...
        'Export and import carry device metadata, log extras, photos, and places in JSON, CSV, and plain text.',
      ],
      fa: [
        'حساب اختیاری با شماره تلفن — با کد یک‌بارمصرف وارد شوید، یا کاملاً آفلاین از برنامه استفاده کنید.',
        'زبانهٔ نمایه — وقتی وارد شده‌اید نام و عکس را ببینید و ویرایش کنید؛ با یک ضربه خارج شوید.',
        'قفل برنامه — با رمز، پین یا اثر انگشت محافظت کنید؛ پس از بیکاری باز کنید؛ اگر فراموش کردید با OTP تلفن قفل را بازنشانی کنید.',
        ...
        'از صفحهٔ اصلی یا مدیریت دستگاه‌ها، دستگاه‌ها، تولدها و مکان‌ها را با نام جستجو کنید.',
        'مکان‌ها را روی نقشه ذخیره کنید (نقطه، مسیر یا ناحیه) و از صفحهٔ اصلی باز کنید.',
        ...
        'خروجی و ورود داده، متادادهٔ دستگاه، جزئیات گزارش، عکس‌ها و مکان‌ها را در JSON، CSV و متن ساده منتقل می‌کند.',
      ],
    ),
    ChangelogEntry(
      version: '1.2.0',
