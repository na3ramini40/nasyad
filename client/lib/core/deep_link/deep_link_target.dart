...
final class DeepLinkPlaces extends DeepLinkTarget {
  const DeepLinkPlaces();
}

final class DeepLinkPlaceNew extends DeepLinkTarget {
  const DeepLinkPlaceNew();
}

final class DeepLinkPlaceEdit extends DeepLinkTarget {
  const DeepLinkPlaceEdit({required this.id});
