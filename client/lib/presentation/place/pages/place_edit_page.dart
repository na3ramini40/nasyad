...
class _PlaceEditPageState extends State<PlaceEditPage> {
  ...
  String _mapHint(AppLocalizations l10n, PlaceEditState state) {
    return switch (state.kind) {
      ...
      PlaceGeometryKind.polygon => l10n.placeMapHintArea(state.points.length),
    };
  }
      ...
      listener: (context, state) {
        ...
        if (state.locationDenied) {
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text(l10n.placeLocationDenied)));
        }
                      ...
                      children: [
                        AppTextField(
                          ...
                          onChanged: (value) => context
                              .read<PlaceEditBloc>()
                              .add(PlaceEditNameChanged(value)),
                        ),
