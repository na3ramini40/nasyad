  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<TransferBloc, TransferState>(
      ...
      listener: (context, state) {
        ...
        final message = switch (state.feedback) {
          ...
          TransferFeedback.importSuccess => l10n.importSuccess(
            state.importSuccessDevices,
            state.importSuccessBirthdays,
            state.importSuccessPlaces,
          ),
      ...
      builder: (context, state) {
        ...
        final noDevicesMessage = state.scope == ExportScopeKind.all
            ? l10n.noDataForExport
                ...
                if (state.importPreview != null) ...[
                  ...
                  Text(
                    l10n.importPreview(
                      ...
                      state.importPreview!.birthdayCount,
                      state.importPreview!.placeCount,
                    ),
                  ),
