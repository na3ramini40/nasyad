...
final class TransferState extends Equatable {
  const TransferState({
    ...
    this.feedbackDetail,
    this.importSuccessDevices = 0,
    this.importSuccessBirthdays = 0,
    this.importSuccessPlaces = 0,
    this.errorMessage,
  });
  ...
  final int importSuccessDevices;
  final int importSuccessBirthdays;
  final int importSuccessPlaces;
  ...
  bool get canExport {
    ...
    return switch (scope) {
      // "All data" may be birthdays/places only — TransferService validates emptiness.
      ExportScopeKind.all => true,
  ...
  TransferState copyWith({
    ...
    int? importSuccessDevices,
    int? importSuccessBirthdays,
    int? importSuccessPlaces,
    String? errorMessage,
    ...
    return TransferState(
      ...
      importSuccessDevices: clearFeedback
          ? 0
          : (importSuccessDevices ?? this.importSuccessDevices),
      importSuccessBirthdays: clearFeedback
          ? 0
          : (importSuccessBirthdays ?? this.importSuccessBirthdays),
      importSuccessPlaces: clearFeedback
          ? 0
          : (importSuccessPlaces ?? this.importSuccessPlaces),
  ...
  List<Object?> get props => [
    ...
    feedback,
    feedbackDetail,
    importSuccessDevices,
    importSuccessBirthdays,
    importSuccessPlaces,
    errorMessage,
  ];
}
