...
class BirthdayDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<List<BirthdaysTableData>> getAll() {
    return (select(
      birthdaysTable,
  ...
  Future<int> upsertBirthday(BirthdaysTableCompanion birthday) {
    return into(birthdaysTable).insertOnConflictUpdate(birthday);
  }
